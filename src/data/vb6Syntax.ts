...
export const vb6Functions = [
  ...
  { name: 'Space', syntax: 'Space(number)', description: 'Returns a string of spaces' },
  {
    ...
    description: 'Returns a repeating character string',
  },
  ...
  },
  {
    ...
    description: 'Returns a part of a date',
  },
  ...
  {
    name: 'Filter',
    syntax: 'Filter(array, match[, include[, compare]])',
    description: 'Returns an array containing subset of a string array',
  },
  ...
  // File Functions
  {
    ...
    description: 'Returns the name of a file or directory',
  },
  ...
  { name: 'FileLen', syntax: 'FileLen(pathname)', description: 'Returns the length of a file' },
  {
    ...
    description: 'Returns the date and time a file was last modified',
  },
  {
    name: 'FreeFile',
  ...
  },
  {
    ...
    description: 'Displays an input box',
  },
  {
    name: 'Shell',
  ...
  },
  {
    ...
    description: 'Returns True if expression is a date',
  },
  {
    name: 'IsEmpty',
    syntax: 'IsEmpty(expression)',
    description: 'Returns True if variable is uninitialized',
  },
  {
    name: 'IsError',
    syntax: 'IsError(expression)',
    description: 'Returns True if expression is an error',
  },
  {
    name: 'IsNull',
    syntax: 'IsNull(expression)',
    description: 'Returns True if expression is Null',
  },
  {
    name: 'IsNumeric',
    syntax: 'IsNumeric(expression)',
    description: 'Returns True if expression is a number',
  },
  {
    name: 'IsObject',
    syntax: 'IsObject(expression)',
    description: 'Returns True if expression is an object',
  },
  {
    name: 'TypeName',
    syntax: 'TypeName(varname)',
    description: 'Returns the data type name of a variable',
  },
  {
    name: 'VarType',
    syntax: 'VarType(varname)',
    description: 'Returns the data type of a variable',
  },
];
...
export const vb6Properties: Record<string, string[]> = {
  ...
  Image: ['Picture', 'Stretch', 'BorderStyle'],
  Timer: ['Interval', 'Enabled'],
  HScrollBar: ['Value', 'Min', 'Max', 'LargeChange', 'SmallChange'],
  VScrollBar: ['Value', 'Min', 'Max', 'LargeChange', 'SmallChange'],
  TreeView: [
    'Nodes',
    'SelectedItem',
    'Style',
