...
export class VB6AppObject {
  ...
  set EXEName(value: string) { this._exeName = value; }
  ...
  set Major(value: number) { this._major = value; }
  
  get Minor(): number { return this._minor; }
  set Minor(value: number) { this._minor = value; }
  
  get Revision(): number { return this._revision; }
  set Revision(value: number) { this._revision = value; }
  
  get Comments(): string { return this._comments; }
  set Comments(value: string) { this._comments = value; }
  ...
  set FileDescription(value: string) { this._fileDescription = value; }
  
  get LegalCopyright(): string { return this._legalCopyright; }
  set LegalCopyright(value: string) { this._legalCopyright = value; }
  
  get LegalTrademarks(): string { return this._legalTrademarks; }
  set LegalTrademarks(value: string) { this._legalTrademarks = value; }
  ...
  get PrevInstance(): boolean { return this._prevInstance; }
  ...
  get NonModalAllowed(): boolean { return this._nonModalAllowed; }
  set NonModalAllowed(value: boolean) { this._nonModalAllowed = value; }
  
  get CompileMode(): AppConstants { return this._compileMode; }
  
  get UnattendedApp(): boolean { return this._unattendedApp; }
  set UnattendedApp(value: boolean) { this._unattendedApp = value; }
  
  get RetainedProject(): boolean { return this._retainedProject; }
  set RetainedProject(value: boolean) { this._retainedProject = value; }
  
  get TaskVisible(): boolean { return this._taskVisible; }
  set TaskVisible(value: boolean) { this._taskVisible = value; }
  
  get OLEServerBusyTimeout(): number { return this._oLEServerBusyTimeout; }
  set OLEServerBusyTimeout(value: number) { this._oLEServerBusyTimeout = value; }
  
  get OLEServerBusyMsgText(): string { return this._oLEServerBusyMsgText; }
  set OLEServerBusyMsgText(value: string) { this._oLEServerBusyMsgText = value; }
  
  get OLEServerBusyMsgTitle(): string { return this._oLEServerBusyMsgTitle; }
  set OLEServerBusyMsgTitle(value: string) { this._oLEServerBusyMsgTitle = value; }
  
  get OLERequestPendingTimeout(): number { return this._oLERequestPendingTimeout; }
  set OLERequestPendingTimeout(value: number) { this._oLERequestPendingTimeout = value; }
  
  get OLERequestPendingMsgText(): string { return this._oLERequestPendingMsgText; }
  set OLERequestPendingMsgText(value: string) { this._oLERequestPendingMsgText = value; }
  
  get OLERequestPendingMsgTitle(): string { return this._oLERequestPendingMsgTitle; }
  set OLERequestPendingMsgTitle(value: string) { this._oLERequestPendingMsgTitle = value; }
...
export class VB6ScreenObject {
  ...
  // Properties
  get ActiveControl(): any { return this._activeControl; }
  set ActiveControl(value: any) { this._activeControl = value; }
  
  get ActiveForm(): any { return this._activeForm; }
  set ActiveForm(value: any) { this._activeForm = value; }
  
  get MousePointer(): number { return this._mousePointer; }
  set MousePointer(value: number) { 
    this._mousePointer = value;
    this.updateCursor(value);
  }
  
  get MouseIcon(): any { return this._mouseIcon; }
  set MouseIcon(value: any) { 
    this._mouseIcon = value;
    if (this._mousePointer === 99) { // Custom cursor
      this.updateCursor(99);
    }
  }
  
  get Fonts(): string[] { return this._fonts; }
  
  get FontCount(): number { return this._fontCount; }
  ...
  get TwipsPerPixelX(): number { return this._twipsPerPixelX; }
  
  get TwipsPerPixelY(): number { return this._twipsPerPixelY; }
