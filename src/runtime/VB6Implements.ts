      ...
      switch (member.type) {
        ...
        case InterfaceMemberType.Property: {
          ...
          if (!descriptor && !member.isOptional) {
            ...
            if (
              (member.propertyType === 'Let' || member.propertyType === 'Set') &&
              !descriptor.set
            ) {
      ...
      members: [
        {
          ...
          type: InterfaceMemberType.Method,
          parameters: [{ name: 'pctinfo', type: 'Long', byRef: true }],
          returnType: 'Long',
        },
        {
          name: 'GetTypeInfo',
      ...
      members: [
        {
          name: 'CompareTo',
          type: InterfaceMemberType.Method,
          parameters: [{ name: 'obj', type: 'Object', byRef: false }],
          returnType: 'Integer',
        },
      ],
    });
...
DefineInterface({
  ...
  members: [
    ...
    },
    {
      name: 'Draw',
      type: InterfaceMemberType.Method,
      parameters: [{ name: 'canvas', type: 'Object', byRef: false }],
    },
    {
      name: 'Move',
      type: InterfaceMemberType.Method,
...
DefineInterface({
  ...
  members: [
    ...
    },
    {
      ...
      type: InterfaceMemberType.Property,
      propertyType: 'Let',
      parameters: [{ name: 'value', type: 'Long', byRef: false }],
    },
    {
      name: 'Fill',
      type: InterfaceMemberType.Method,
      parameters: [{ name: 'color', type: 'Long', byRef: false }],
    },
  ],
});
