...
describe('Project Explorer Tests', () => {
  ...
  beforeEach(() => {
    ...
    mockProject = {
      ...
      classes: [{ name: 'Class1', path: 'Class1.cls', type: 'class' }],
      references: [
  ...
  describe('File Status and Indicators', () => {
    it('should show modified file indicator', () => {
      const projectWithModified = {
        ...mockProject,
        forms: [{ ...mockProject.forms[0], modified: true }, mockProject.forms[1]],
      };
    ...
    it('should show file size information', async () => {
      const projectWithSizes = {
        ...mockProject,
        forms: [{ ...mockProject.forms[0], size: 1024 }, mockProject.forms[1]],
      };
  ...
  describe('References Management', () => {
    ...
    it('should remove references', async () => {
      ...
      render(
        <ProjectExplorer project={mockProject} onRemoveReference={onRemoveReference} expanded />
      );
    ...
    it('should validate reference conflicts', async () => {
      ...
      const conflictingRef = screen
        .getByText('Microsoft ActiveX Data Objects 6.0')
        .closest('.tree-item');
  ...
  describe('Performance and Virtualization', () => {
    ...
    it('should lazy load file details', async () => {
      ...
      render(
        <ProjectExplorer project={mockProject} onLoadFileDetails={mockLoadFileDetails} expanded />
      );
