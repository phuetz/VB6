...
describe('Collaboration Features Tests', () => {
  ...
  describe('Collaboration Manager', () => {
    ...
    it('should handle incoming changes from other users', async () => {
      ...
      render(<CollaborationManager service={mockCollaborationService} onFormChange={onFormChange} />);
    ...
    it('should merge concurrent changes', async () => {
      ...
      const change1 = {
        type: 'FORM_CHANGE',
        data: { type: 'PROPERTY_CHANGED', controlId: 'Button1', property: 'Caption', value: 'A', userId: '1', timestamp: 1000 }
      };
      
      const change2 = {
        type: 'FORM_CHANGE',
        data: { type: 'PROPERTY_CHANGED', controlId: 'Button1', property: 'Caption', value: 'B', userId: '2', timestamp: 1001 }
      };
    ...
    it('should handle conflict resolution', async () => {
      ...
      const conflictingChanges = [
        { type: 'PROPERTY_CHANGED', controlId: 'Button1', property: 'Left', value: 100, userId: '1', timestamp: 1000 },
        { type: 'PROPERTY_CHANGED', controlId: 'Button1', property: 'Left', value: 200, userId: '2', timestamp: 1000 }
      ];
    ...
    it('should maintain operation history', async () => {
      ...
      const operations = [
        ...
        { type: 'PROPERTY_CHANGED', controlId: 'Button1', property: 'Caption', value: 'Test', userId: '1' }
      ];
  ...
  describe('Collaboration Panel', () => {
    ...
    it('should handle user interactions', async () => {
      ...
      render(<CollaborationPanel users={mockUsers} currentUser={mockUsers[0]} onUserClick={onUserClick} />);
    ...
    it('should show user permissions', async () => {
      ...
      render(<CollaborationPanel users={usersWithPermissions} currentUser={usersWithPermissions[0]} />);
  ...
  describe('Collaboration Cursors', () => {
    ...
    it('should animate cursor movements', async () => {
      ...
      const updatedCursors = [
        { ...mockCursors[0], position: { x: 150, y: 250 } },
        mockCursors[1]
      ];
  ...
  describe('Real-time Synchronization', () => {
    it('should sync control property changes', async () => {
      ...
      render(<CollaborationManager service={mockCollaborationService} onPropertyChange={onPropertyChange} />);
    ...
    it('should sync control additions', async () => {
      ...
      render(<CollaborationManager service={mockCollaborationService} onControlAdd={onControlAdd} />);
      ...
      act(() => {
        mockCollaborationService.onMessage.mock.calls[0][0]({ type: 'FORM_CHANGE', data: newControl });
      });
    ...
    it('should sync control deletions', async () => {
      ...
      render(<CollaborationManager service={mockCollaborationService} onControlDelete={onControlDelete} />);
      ...
      act(() => {
        mockCollaborationService.onMessage.mock.calls[0][0]({ type: 'FORM_CHANGE', data: deletion });
      });
    ...
    it('should handle form structure changes', async () => {
      ...
      render(<CollaborationManager service={mockCollaborationService} onStructureChange={onStructureChange} />);
      ...
      act(() => {
        mockCollaborationService.onMessage.mock.calls[0][0]({ type: 'FORM_CHANGE', data: structureChange });
      });
  ...
  describe('Collaboration Analytics', () => {
    it('should track user activity', async () => {
      ...
      activities.forEach(activity => {
        act(() => {
          mockCollaborationService.onMessage.mock.calls[0][0]({ type: 'USER_ACTIVITY', data: activity });
        });
      });
  ...
  describe('Offline Synchronization', () => {
    it('should queue changes when offline', async () => {
      ...
      const change = { type: 'PROPERTY_CHANGED', controlId: 'Button1', property: 'Caption', value: 'Offline Change' };
    ...
    it('should handle sync conflicts after reconnection', async () => {
      ...
      render(<CollaborationManager service={mockCollaborationService} onConflictResolution={onConflictResolution} />);
  ...
  describe('Access Control', () => {
    ...
    it('should handle permission changes', async () => {
      ...
      act(() => {
        mockCollaborationService.onMessage.mock.calls[0][0]({ type: 'SYSTEM_MESSAGE', data: permissionChange });
      });
