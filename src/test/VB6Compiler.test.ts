...
describe('VB6Compiler', () => {
  ...
  describe('Error Handling', () => {
    ...
    it('should handle missing variable declarations', async () => {
      ...
      expect(
        result.errors.some(e => e.message.includes('undeclared') || e.message.includes('undefined'))
      ).toBe(true);
    });
    ...
    it('should handle circular dependencies', async () => {
      ...
      expect(
        result.errors.some(e => e.message.includes('circular') || e.message.includes('dependency'))
      ).toBe(true);
    });
  });
