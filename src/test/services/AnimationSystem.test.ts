...
describe('Animation System Tests', () => {
  ...
  describe('Basic Animations', () => {
    it('should create fade in animation', async () => {
      ...
      expect(element.animate).toHaveBeenCalledWith([{ opacity: '0' }, { opacity: '1' }], {
        duration: 500,
        easing: 'ease-in-out',
        fill: 'forwards',
      });
    ...
    it('should create fade out animation', async () => {
      ...
      expect(element.animate).toHaveBeenCalledWith([{ opacity: '1' }, { opacity: '0' }], {
        duration: 300,
        easing: 'ease-in-out',
        fill: 'forwards',
      });
  ...
  describe('Animation Groups and Sequences', () => {
    ...
    it('should create timeline animations', async () => {
      ...
      const timeline = animationService.timeline([
        ...
        {
          at: 300,
          animation: () => animationService.rotate(element, { degrees: 180, duration: 400 }),
        },
      ]);
  ...
  describe('Performance Optimizations', () => {
    ...
    it('should batch animations for better performance', () => {
      ...
      animationService.batchAnimate(elements, el => animationService.fadeIn(el, { duration: 300 }));
