...
export const IconEditor: React.FC<IconEditorProps> = ({
  ...
  const undo = useCallback(() => {
    if (historyIndex > 0) {
      ...
      updateLayer(layer.id, { data: new ImageData(
  ...
  const setPixel = useCallback((x: number, y: number, color: string, alpha: number = 255) => {
    const layer = getCurrentLayer();
  ...
  const drawRectangle = useCallback((x0: number, y0: number, x1: number, y1: number, color: string, filled: boolean) => {
  ...
  const drawEllipse = useCallback((cx: number, cy: number, rx: number, ry: number, color: string, filled: boolean) => {
  ...
  }, [zoom, selectedTool, primaryColor, secondaryColor, setPixel, floodFill, getPixelColor, saveToHistory]);
          ...
          <div className="p-4 border-b border-gray-200">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                >
                  {Object.values(IconSize).filter(s => typeof s === 'number').map(size => (
              ...
              <div className="flex justify-between">
                ...
                <select
                  ...
                  onChange={(e) => setProject(prev => ({ ...prev, format: e.target.value as IconFormat }))}
                  className="px-2 py-1 border border-gray-300 rounded"
                >
              ...
              <div className="flex justify-between">
                ...
                <select
                  ...
                  onChange={(e) => setProject(prev => ({ ...prev, colorDepth: parseInt(e.target.value) as IconColorDepth }))}
                  className="px-2 py-1 border border-gray-300 rounded"
                >
              ...
              {project.layers.map(layer => (
                <div
                  ...
                  className={`p-2 border rounded cursor-pointer text-sm ${
                    selectedLayer === layer.id ? 'border-blue-500 bg-blue-50' : 'border-gray-300 hover:bg-gray-50'
                  }`}
                >
                  <div className="flex items-center justify-between">
