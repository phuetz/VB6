...
export const PropertyPageWizard: React.FC<PropertyPageWizardProps> = ({
  ...
  const [wizardData, setWizardData] = useState<PropertyPageConfiguration>(
    () =>
      configuration || {
  ...
  const availableProperties = [
    ...
    { name: 'Width', displayName: 'Width', dataType: PropertyDataType.LONG, category: 'Position' },
    {
      name: 'Height',
      displayName: 'Height',
      dataType: PropertyDataType.LONG,
      category: 'Position',
    },
    ...
    { name: 'Tag', displayName: 'Tag', dataType: PropertyDataType.STRING, category: 'Data' },
    {
      name: 'Picture',
      displayName: 'Picture',
      dataType: PropertyDataType.PICTURE,
      category: 'Appearance',
    },
    {
      name: 'BorderStyle',
              ...
              ctrl.type === ControlType.TEXTBOX
                ...
                : ctrl.type === ControlType.CHECKBOX
                  ...
                  : ctrl.type === ControlType.COMBOBOX
                    ? 'Text'
                    : ctrl.type === ControlType.COLORPICKER
                      ? 'Color'
                      : ctrl.type === ControlType.FONTPICKER
                        ? 'Font'
                        : 'Value',
  ...
  const addControl = (type: ControlType) => {
    const newControl: PropertyPageControl = {
      ...
      type,
      caption:
        type === ControlType.LABEL ? 'Label:' : type === ControlType.COMMANDBUTTON ? 'Button' : '',
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            onChange={e =>
              setWizardData({ ...wizardData, helpContextID: parseInt(e.target.value) || 0 })
            }
            className="w-full px-3 py-2 border rounded focus:ring-2 focus:ring-blue-500"
          />
        </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            onChange={e =>
              setWizardData({ ...wizardData, height: parseInt(e.target.value) || 156 })
            }
            className="w-full px-3 py-2 border rounded focus:ring-2 focus:ring-blue-500"
            min="80"
            max="600"
    ...
    <div className="space-y-6">
        ...
        {Object.values(PropertyPageType).map(type => (
          ...
          >
            <div className="flex items-center gap-3">
              ...
              {type === PropertyPageType.APPEARANCE && (
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">
                  {type === PropertyPageType.GENERAL &&
                    'Basic control properties like name, caption, enabled'}
                  {type === PropertyPageType.APPEARANCE &&
                    'Visual properties like colors, borders, alignment'}
                  {type === PropertyPageType.FONT &&
                    'Font selection and text formatting properties'}
      ...
      <div className="bg-blue-50 border border-blue-200 rounded p-4">
        ...
        <div className="text-sm text-blue-700">
          This will generate a template layout with appropriate controls and property mappings. You
          can customize the layout in the next steps.
        </div>
      </div>
    </div>
  );
                  ...
                  <div className="grid grid-cols-2 gap-2 flex-1">
                    ...
                    <div>
                      ...
                      <select
                        value={control.type}
                        onChange={e =>
                          updateControl(control.id, { type: e.target.value as ControlType })
                        }
                        className="w-full px-2 py-1 border rounded text-sm"
                      >
                ...
                <div className="grid grid-cols-2 gap-2 mb-2">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        updateControl(control.id, { tabIndex: parseInt(e.target.value) || 0 })
                      }
                      className="w-full px-2 py-1 border rounded text-sm"
                    />
                  </div>
                ...
                <div className="grid grid-cols-4 gap-2">
                  <div>
                    ...
                    <input
                      ...
                      value={control.left}
                      onChange={e =>
                        updateControl(control.id, { left: parseInt(e.target.value) || 0 })
                      }
                      className="w-full px-2 py-1 border rounded text-sm"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      value={control.top}
                      onChange={e =>
                        updateControl(control.id, { top: parseInt(e.target.value) || 0 })
                      }
                      className="w-full px-2 py-1 border rounded text-sm"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      value={control.width}
                      onChange={e =>
                        updateControl(control.id, { width: parseInt(e.target.value) || 0 })
                      }
                      className="w-full px-2 py-1 border rounded text-sm"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        updateControl(control.id, { height: parseInt(e.target.value) || 0 })
                      }
                      className="w-full px-2 py-1 border rounded text-sm"
                    />
                  </div>
    ...
    <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4 mb-3">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={e =>
                    updateMapping(mapping.id, { dataType: e.target.value as PropertyDataType })
                  }
                  className="w-full px-2 py-1 border rounded text-sm"
                >
      ...
      {wizardData.mappings.length === 0 && (
        <div className="text-center py-8 text-gray-500">
          ...
          <p className="text-sm">
            Click "Add Mapping" to connect control properties to your ActiveX control
          </p>
        </div>
      )}
    </div>
      ...
      <div className="grid grid-cols-2 gap-6">
              ...
              <input
                ...
                onChange={e =>
                  setWizardData({
                    ...
                    codeGeneration: {
                      ...wizardData.codeGeneration,
                      generateErrorHandling: e.target.checked,
                    },
                  })
                }
              />
        ...
        <div className="bg-blue-50 border border-blue-200 rounded p-4">
          ...
          <div className="text-sm text-blue-700 space-y-1">
            <div>
              Type: <strong>{wizardData.type}</strong>
            </div>
            <div>
              Controls: <strong>{wizardData.controls.length}</strong>
            </div>
            <div>
              Mappings: <strong>{wizardData.mappings.length}</strong>
            </div>
            <div>
              Target: <strong>{wizardData.targetControl}</strong>
            </div>
            <div>
              Size:{' '}
              <strong>
                {wizardData.width} × {wizardData.height}
              </strong>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-green-50 border border-green-200 rounded p-4">
          ...
          <ul className="text-sm text-green-700 space-y-1">
            ...
            {wizardData.codeGeneration.generateErrorHandling && (
