...
export const useIDEShortcuts = (actions: {
  ...
  const shortcuts: KeyboardShortcut[] = [
    ...
    // Snippets
    {
      ...
      ctrlKey: true,
      action: () => {},
      description: 'Snippets (multi-part)',
      preventDefault: false,
    },
    {
      keys: ['s'],
      ctrlKey: true,
      action: actions.showSnippets,
    ...
    // Window operations
    {
      keys: ['g'],
      ctrlKey: true,
      action: actions.showImmediateWindow,
      description: 'Immediate Window',
    },
    {
      keys: ['w'],
      ctrlKey: true,
      altKey: true,
      action: actions.showWatchWindow,
      description: 'Watch Window',
    },
    {
      keys: ['f2'],
      ctrlKey: true,
      action: actions.showObjectBrowser,
    ...
    },
    {
      ...
      ctrlKey: true,
      altKey: true,
      action: actions.showProjectExplorer,
    ...
    { keys: ['f4'], action: actions.showPropertiesWindow, description: 'Properties Window' },
    {
      ...
      ctrlKey: true,
      altKey: true,
      action: actions.showToolbox,
      description: 'Toolbox',
    },
    {
      keys: ['f7'],
      shiftKey: true,
      action: actions.showFormDesigner,
    ...
    { keys: ['f7'], action: actions.showCodeEditor, description: 'Code Editor' },
    {
      keys: ['f4'],
      ctrlKey: true,
      action: actions.closeActiveWindow,
...
export const useCodeEditorShortcuts = (actions: {
  ...
  const shortcuts: KeyboardShortcut[] = [
    ...
    // Line insertion
    {
      keys: ['enter'],
      ctrlKey: true,
      action: actions.insertLineAbove,
    ...
    },
    {
      ...
      ctrlKey: true,
      shiftKey: true,
      action: actions.insertLineBelow,
    ...
    // Brace matching
    {
      keys: [']'],
      ctrlKey: true,
      action: actions.jumpToMatchingBrace,
    ...
    },
    {
      ...
      ctrlKey: true,
      shiftKey: true,
      action: actions.selectToMatchingBrace,
      description: 'Select to Matching Brace',
    },
    ...
    // IntelliSense
    {
      keys: [' '],
      ctrlKey: true,
      action: actions.showIntelliSense,
    ...
    },
    {
      ...
      ctrlKey: true,
      shiftKey: true,
      action: actions.showParameterInfo,
