...
export const useAnimations = (): UseAnimationsReturn => {
  ...
  const animateMove = useCallback(
    async (
      ...
      const animationPromise = animationService.animateMove(
        controlIds,
        fromPositions,
        toPositions,
        {
  ...
  const animateSnapToGrid = useCallback(
    async (
      ...
      const animationPromise = animationService.animateSnapToGrid(
        controlIds,
        fromPositions,
        toPositions,
        {
  ...
  const animateAlignment = useCallback(
    async (
      controls: Control[],
      fromPositions: Array<{ id: number; x: number; y: number }>,
      toPositions: Array<{ id: number; x: number; y: number }>,
...
export const useControlAnimations = () => {
  ...
  const animateControlCreation = useCallback(
    async (controls: Control[]) => {
      const controlIds = controls.map(c => c.id);
  ...
  const animateControlDeletion = useCallback(
    async (controls: Control[]) => {
      const controlIds = controls.map(c => c.id);
  ...
  const animateDragMovement = useCallback(
    async (
      controls: Control[],
      fromPositions: Array<{ id: number; x: number; y: number }>,
      toPositions: Array<{ id: number; x: number; y: number }>
  ...
  const animateControlResize = useCallback(
    async (
      controls: Control[],
      fromSizes: Array<{ id: number; x: number; y: number; width: number; height: number }>,
      toSizes: Array<{ id: number; x: number; y: number; width: number; height: number }>
  ...
  const animateControlPaste = useCallback(
    async (controls: Control[]) => {
      const controlIds = controls.map(c => c.id);
