  ...
  const formatCode = () => {
    ...
    setTimeout(() => {
      ...
      if (formatOptions.capitalizeKeywords) {
        const keywords = ['Sub', 'Function', 'Dim', 'As', 'If', 'Then', 'Else', 'ElseIf', 'End', 'For', 'To', 'Next', 'While', 'Wend', 'Do', 'Loop'];
      ...
      result = lines.map(line => {
        ...
        if (/^End\s+(Sub|Function|If|Select|With)/.test(trimmedLine) || 
        ...
        if (/^(Sub|Function|If|For|Do|While)\b/.test(trimmedLine) && 
                  ...
                  <div className="bg-white p-3 border border-gray-300 rounded h-[220px] overflow-auto">
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="mt-4 pt-4 border-t border-gray-200">
                        <div className="text-xs text-gray-600 mb-2">Select a preset formatting style:</div>
