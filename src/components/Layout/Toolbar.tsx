...
const Toolbar: React.FC = () => {
  ...
  const showDebugWindow = useWindowStore(state => state.showDebugWindow);
  ...
  return (
    <div className="bg-white border-b border-gray-200 shadow-sm">
      {/* Main Toolbar */}
      <div className="flex items-center px-4 py-2 gap-2" role="toolbar" aria-label="Main Toolbar">
        {/* Logo/Home */}
        <button
          className="flex items-center gap-2 pr-4 hover:opacity-80 transition-opacity"
          aria-label="VB6 Studio Home"
        >
        ...
        <div className="flex items-center gap-1" role="group" aria-label="File Operations">
          <ToolbarButton
            ...
            onClick={() => windowShowDialog('showNewProjectDialog', true)}
          />
          <ToolbarButton
          ...
          <ToolbarButton
            ...
            onClick={() => windowShowDialog('showExportDialog', true)}
          />
        </div>
        ...
        {/* Edit Operations */}
        <div className="flex items-center gap-1" role="group" aria-label="Edit Operations">
          <ToolbarButton
            icon={<Undo size={18} />}
            tooltip="Undo (Ctrl+Z)"
            onClick={undo}
        ...
        {/* Alignment Tools */}
        <div className="flex items-center gap-1" role="group" aria-label="Alignment Tools">
          <ToolbarButton
        ...
        {/* Execution Controls */}
        <div className="flex items-center gap-1" role="group" aria-label="Execution Controls">
          <ToolbarButton
          ...
          <ToolbarButton
            icon={<Bug size={18} />}
            tooltip="Debug Mode"
            onClick={() => toggleWindow('showDebugWindow')}
            active={showDebugWindow}
          />
        </div>
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <div className={`relative transition-all duration-300 ${searchOpen ? 'w-64' : 'w-auto'}`}>
            ...
            {searchOpen && (
              <input
                ...
                aria-label="Search controls and properties"
                autoFocus
          ...
          <ToolbarButton
            ...
            tooltip="Settings"
            onClick={() => windowShowDialog('showSettingsDialog', true)}
          />
        </div>
      </div>
      ...
      {/* Status Bar */}
      <div
        className="bg-gray-50 border-t border-gray-200 px-4 py-1 flex items-center justify-between text-xs text-gray-600"
        role="status"
        aria-live="polite"
        aria-label="Toolbar Status"
      >
