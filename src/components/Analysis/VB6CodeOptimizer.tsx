...
class VB6CodeAnalyzer {
      ...
      if (trimmedLine.includes('for i = 1 to ubound(')) {
        issues.push({
          ...
          suggestedCode: line.replace(
            /for i = 1 to ubound\(([^)]+)\)/gi,
            'Dim upperBound As Long: upperBound = UBound($1): For i = 1 To upperBound'
          ),
  ...
  private analyzeMemoryUsage(lines: string[], fileName: string): CodeIssue[] {
    ...
    lines.forEach((line, index) => {
      ...
      if (trimmedLine.includes('set ') && trimmedLine.includes('= new ')) {
        ...
        const hasSetNothing = nextLines.some(
          l => l.toLowerCase().includes('set ') && l.toLowerCase().includes('= nothing')
        );
  ...
  private analyzeMaintainability(lines: string[], fileName: string): CodeIssue[] {
    ...
    lines.forEach((line, index) => {
      ...
      if (
        trimmedLine.toLowerCase().startsWith('sub ') ||
        trimmedLine.toLowerCase().startsWith('function ')
      ) {
...
export const VB6CodeOptimizer: React.FC<VB6CodeOptimizerProps> = ({ visible, onClose }) => {
      ...
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow-2xl w-full max-w-7xl h-5/6 flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 border-b dark:border-gray-700">
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">VB6 Code Optimizer</h2>
            {result && (
                  ...
                  <div
                    className={`ml-2 px-2 py-1 rounded text-xs font-bold ${
                      result.maintainabilityScore >= 80
                        ? 'bg-green-100 text-green-800'
                        : result.maintainabilityScore >= 60
                          ? 'bg-yellow-100 text-yellow-800'
                          : 'bg-red-100 text-red-800'
                    }`}
                  >
              ...
              {!result ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">
                    Click "Analyze Code" to start optimization analysis
                  </p>
                </div>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500 text-sm">
                    Your code looks good for the selected filters.
                  </p>
                </div>
              ) : (
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <div className="flex items-center mt-2 text-sm text-gray-500">
                        ...
                        <span
                          className={`px-2 py-1 rounded text-xs font-medium ${getSeverityColor(selectedIssue.severity)}`}
                        >
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {selectedIssue.file} line {selectedIssue.line}, column{' '}
                              ...
                              <div className="flex items-center">
                                <div className="w-20 bg-gray-200 rounded-full h-2 mr-2">
                                  <div
                                    ...
                                    style={{
                                      width: `${selectedIssue.impact.maintainability * 10}%`,
                                    }}
                                  />
                                </div>
