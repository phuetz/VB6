        ...
        <div className="p-4 h-full flex flex-col">
          ...
          <div className="flex bg-white border border-gray-300 mb-4 rounded p-2 text-sm">
            <div className="flex-1 flex items-center justify-center gap-2">
              ...
              <span>
                <strong>{getIssueCountBySeverity('error')}</strong> Errors
              </span>
            </div>
            ...
            <div className="flex-1 flex items-center justify-center gap-2">
              ...
              <span>
                <strong>{getIssueCountBySeverity('warning')}</strong> Warnings
              </span>
            </div>
            <div className="w-px h-6 bg-gray-300"></div>
            <div className="flex-1 flex items-center justify-center gap-2">
              ...
              <span>
                <strong>{getIssueCountBySeverity('info')}</strong> Information
              </span>
            </div>
            <div className="w-px h-6 bg-gray-300"></div>
            <div className="flex-1 flex items-center justify-center gap-2">
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <div className="bg-gray-100 border border-gray-400 border-b-0 p-2 flex justify-between">
                    ...
                    <div className="text-xs text-gray-600">
                      {getFileIssues(currentFile).length} issue
                      {getFileIssues(currentFile).length !== 1 ? 's' : ''}
                    </div>
                  </div>
                      ...
                      <tbody>
                        {getFileIssues(currentFile).length > 0 ? (
                          getFileIssues(currentFile).map(issue => (
                            ...
                            >
                              <td className="p-2">{getIssueIcon(issue.severity)}</td>
                              ...
                              <td className="p-2">
                                <div className="flex gap-1">
                                  <button
                                    ...
                                    onClick={() =>
                                      onNavigateToIssue(issue.file, issue.line, issue.column)
                                    }
                                    title="Go to issue"
                                  >
                                    <ArrowRight size={12} />
                    ...
                    <div className="space-y-4">
                      <div>
                        <div className="flex justify-between mb-1">
                          ...
                          <span
                            className={`text-xs font-bold ${getQualityColorClass(metrics.qualityScore)}`}
                          >
                            {metrics.qualityScore}%
                          </span>
                        </div>
                      ...
                      <div>
                        <div className="flex justify-between mb-1">
                          ...
                          <span className="text-xs font-bold">{metrics.complexity}</span>
                        </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center p-2 border border-gray-300 rounded">
                        ...
                        <span
                          className={`font-bold text-sm ${metrics.unusedVariables > 5 ? 'text-red-600' : 'text-yellow-600'}`}
                        >
                      ...
                      <div className="flex justify-between items-center p-2 border border-gray-300 rounded">
                        ...
                        <span
                          className={`font-bold text-sm ${metrics.undeclaredVariables > 0 ? 'text-red-600' : 'text-green-600'}`}
                        >
                      ...
                      <div className="flex justify-between items-center p-2 border border-gray-300 rounded">
                        ...
                        <span
                          className={`font-bold text-sm ${metrics.duplicateCode > 3 ? 'text-red-600' : 'text-yellow-600'}`}
                        >
                      ...
                      <div className="flex justify-between items-center p-2 border border-gray-300 rounded">
                        ...
                        <span
                          className={`font-bold text-sm ${metrics.performanceIssues > 3 ? 'text-red-600' : 'text-yellow-600'}`}
                        >
                  ...
                  <div className="space-y-2 text-sm">
                    {metrics.unusedVariables > 0 && (
                      <div className="p-2 bg-yellow-50 border-l-4 border-yellow-500 text-yellow-800">
                        Remove {metrics.unusedVariables} unused variables to improve code
                        maintainability.
                      </div>
                    )}
                    ...
                    {metrics.undeclaredVariables > 0 && (
                      <div className="p-2 bg-red-50 border-l-4 border-red-500 text-red-800">
                        Add 'Option Explicit' and declare {metrics.undeclaredVariables} missing
                        variables to avoid runtime errors.
                      </div>
                    )}
                    ...
                    {metrics.complexity > 30 && (
                      <div className="p-2 bg-purple-50 border-l-4 border-purple-500 text-purple-800">
                        Consider breaking down complex procedures into smaller, more manageable
                        chunks.
                      </div>
                    )}
                  </div>
