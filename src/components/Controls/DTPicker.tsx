...
export const DTPicker = forwardRef<HTMLDivElement, DTPickerProps>((props, ref) => {
  ...
  const vb6Methods = {
    ...
    get Year() {
      return currentValue.getFullYear();
    },
    ...
    get Month() {
      return currentValue.getMonth() + 1;
    }, // VB6 uses 1-based months
    ...
    get Minute() {
      return currentValue.getMinutes();
    },
    ...
    get Second() {
      return currentValue.getSeconds();
    },
