    ...
    >
      ...
      >
        {filteredItems.map((item, index) => (
          ...
          >
            <div
              className={`w-5 h-5 flex-shrink-0 rounded flex items-center justify-center mr-2 ${getColorForType(item.type)}`}
            >
      ...
      {showDocumentation && selectedItem && (
        ...
        >
          ...
          >
            <div
              className={`w-5 h-5 flex-shrink-0 rounded flex items-center justify-center mr-1 ${getColorForType(selectedItem.type)}`}
            >
          ...
          <div className="text-xs mb-3">{selectedItem.description}</div>
          ...
          {selectedItem.snippet && (
            <div className="text-xs">
              ...
              <div
                className={`p-2 rounded font-mono text-xs whitespace-pre ${
