...
// RDO Environment
router.post('/environment/create', asyncHandler(async (req: Request, res: Response) => {
...
// RDO Resultset
router.post('/resultset/open', asyncHandler(async (req: Request, res: Response) => {
...
// RDO Query
router.post('/query/create', asyncHandler(async (req: Request, res: Response) => {
...
router.post('/query/:id/execute', asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
...
// Prepared statements
router.post('/preparedstatement/create', asyncHandler(async (req: Request, res: Response) => {
...
// Async operations
router.post('/connection/:id/execute/async', asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
  ...
  try {
    ...
    dbPool.execute(id, sql).then(result => {
...
router.get('/async/:id/status', asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.post('/async/:id/cancel', asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.get('/connection/:id/tables', asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
...
// Batch updates
router.post('/resultset/:id/batchupdate', asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
