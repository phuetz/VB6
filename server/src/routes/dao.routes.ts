...
router.post(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    try {
      ...
      if (queryDef.type === 1 || queryDef.type === 4) {
        // Action or DDL query
        res.json({
          success: true,
